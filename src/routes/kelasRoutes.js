...
import { getAllKelas, createKelas, getKelasById, updateKelas, deleteKelas } from "../controllers/kelasController.js";
...
router.post("/buat-kelas", authMiddleware, requireAdminOrSuperadmin, createKelas);
